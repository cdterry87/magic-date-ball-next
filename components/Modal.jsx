  ...
  return (
    <>
      <dialog id='mdb__modal' className='modal text-gray-900'>
        <div className='modal-box text-xl bg-white'>
          <form method='dialog'>
            <button className='btn btn-sm btn-circle outline-none absolute right-6 top-6 bg-gray-200 text-black hover:bg-gray-300 transition duration-300 ease-in-out border-none'>
              ✕
            </button>
          </form>
          ...
          <div className='flex flex-col gap-5'>
            {isGeolocationEnabled && (
              <div
                role='alert'
                className='alert bg-pink-600 text-white text-xl border-none'
              >
                <svg
            ...
            {isGeolocationEnabled && (
              <div>
                ...
                <input
                  ...
                  min='8000'
                  max='40000'
                  className='range range-xs [--range-shdw:deepPink]'
                  step='8000'
                  value={radius}
            ...
            {!isGeolocationEnabled && (
              <div>
                ...
                <input
                  type='text'
                  className='input input-bordered w-full text-base focus:outline-none bg-white'
            ...
            <div>
              ...
              <select
                className='select select-bordered w-full focus:outline-none text-base bg-white'
                value={price}
            ...
            <div>
              ...
              <input
                type='text'
                className='input input-bordered w-full focus:outline-none text-base bg-white'
            ...
            <div className='flex items-center justify-center'>
              <button
                className='btn rounded-full bg-gradient-to-r from-fuchsia-700 to-red-600 text-white text-xl px-8 border-none'
                onClick={search}
              >
                Ready, Set, Date!
              </button>
